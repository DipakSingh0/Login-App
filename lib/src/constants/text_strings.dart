...
const String boardingtitle3 = "Ride Or Die";
const String boardingsubtitle1 = "Let's start the journey";
const String boardingsubtitle2 = "Get the training sessons";
const String boardingsubtitle3 = "Be a professional Driver";
...
// Validation ...
const String emailCannotEmpty = "Email cannot be empty";
const String invalidEmailFormat = "Invalid email format";
const String noRecordFound = "No record found";

// -- verification
const String emailVerificationTitle = "email verification title";
...
const String emailLinkToResetPassword = "Email Link To Reset Password";
const String accountCreateVerifyEmail = "Account Create Verify Email";
const String resendEmailLink = "Resend Email Link";
